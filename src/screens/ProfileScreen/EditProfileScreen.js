import {
  ...
  export const EditProfileScreen = () => {
    ...
    console.log("🚀 ~ file: index.js:19 ~ ProfileScreen ~ authUser:", authUser?.attributes);
  
    const [firstName, setFirstName] = useState(dbUser?.name || "");
    ...
    const [phoneNumber, setPhoneNumber] = useState(authUser?.attributes?.phone_number || "");
