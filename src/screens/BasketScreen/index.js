...
import { useBasketContext, useOrderContext } from "../../context";
...
const styles = StyleSheet.create({
  ...
  row: { flexDirection: "row", alignItems: "center", marginVertical: 15, paddingHorizontal: 10, },
  ...
  quantityContainer: { backgroundColor: "lightgrey", paddingHorizontal: 5, paddingVertical: 2, marginRight: 10, borderRadius: 3, },
});
